...
let findShortest = (data) => {
  return data.reduce((shortestCharacter, currentCharacter) => {
    // Compare the height of the currentCharacter to the height of the shortestCharacter
    // Convert the height properties from strings to numbers before comparing them
    return Number(currentCharacter.height) < Number(shortestCharacter.height) ? currentCharacter : shortestCharacter;
  }).name;
};
