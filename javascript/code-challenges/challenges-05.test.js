...
------------------------------------------------------------------------------------------------ */
const toLastNames = people => { // function that contains an array of 'people'
...
const addValues = (arr) => {
  ...
  const addedNums = arr.reduce((total, currentValue) => {
...
const addPurchases = (arr) => {
  ...
  let totalAmount = arr.reduce((idx, currentValue) => {

    return idx + currentValue.purchasePrice;
...
const countNumberOfElements = (arr) => {
  ...
  let numberOfArrays = arr.reduce((index) => index + 1, 0);
...
const returnNames = (arr) => {
  let nameOfObject = arr.reduce((listOfNames, currentValue) => {
    listOfNames.push(currentValue.name);
    return listOfNames;
  }, []);
  return nameOfObject;
};
...
const reversedString = (str) => {
  ...
  return [...str].reduce((number, numbers) =>
    numbers + number);
